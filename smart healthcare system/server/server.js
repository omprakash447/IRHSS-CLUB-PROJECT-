...
// Routes - Properly mounted with specific base paths
server.use('/api/auth', authRoutes);        // Authentication routes
server.use('/api/doctor', doctorRoutes);    // Doctor-related routes
server.use('/api/blood', bloodRoutes);      // Blood-related routes
server.use('/api/accidents', accidentRoutes); // Accident-related routes
